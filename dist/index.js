...
const { Converter, AirtableUtils, RemoteConnection, Utils } = (function (APIKEY) {
    ...
    function _formatKey(key) {
        return key
            .split('-')
            .map((word, i) => i !== 0 ? word.substring(0, 1).toUpperCase() + word.substring(1) : word)
            .join('');
    }
    ...
    function createRecords(base, tableId, records) {
        const table = this.selectTable(base, tableId);
        return _throttleTableUsage(records, (r) => table.createRecordsAsync(r)).then((ids) => [].concat.apply([], ids));
    }
     ...
     * @returns {Promise<string[]>}
     */
    function createErrorRecord(base, tableId, errorName, errorType, errorMessage, mappings) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    const customFetch = {
        ...
        _fetch: function (path, method, payload, opts) {
            return __awaiter(this, void 0, void 0, function* () {
                let result = null;
                try {
                    const res = yield fetch(`${this.baseUrl}v${this.airtableVersion}/${path}`, {
                        headers: this._applyHeaders(opts === null || opts === void 0 ? void 0 : opts.baseId),
                        method: method,
                        body: payload ? JSON.stringify(payload) : null,
                    });
                    if (!res.ok)
                        throw new Error(`Fetch Error: ${res.statusText} - ${res.status.toString()}`);
        ...
        _doUpdateRequest: function (baseId, tableId, method, payload, opts) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (payload) {
                    ...
                    const result = yield this._fetch(`${baseId}/${tableId}`, method, null, opts);
                    results.push(result);
                }
                return results;
            });
        ...
        patch: function (baseId, tableId, payload, opts) {
            return __awaiter(this, void 0, void 0, function* () {
                return yield this._doUpdateRequest(baseId, tableId, 'PATCH', payload, opts);
            });
        },
        /** Creates and sends a post request with optional body data
         * @param this {FetchObject}
        ...
        delete: function (baseId, tableId, payload, opts) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                while (payload.length !== 0) {
                    ...
                    const result = yield this._fetch(`${baseId}/${tableId}${delRecs}`, 'DELETE');
                    results.push(...result);
                }
                return results;
            });
